    ...
    , ui(new Ui::ProfilesSelection)
{
    ...
    // set file trees
    {
        ...
        if (QDir(savesDirectory).exists()) {
            presetProfileModel->setRootPath(savesDirectory);
        }
        else qDebug() << "profilesselection.cpp: ERROR, path to saves folder incorrect, setting to root";
    ...
    // connections
    {
        ...
        // animation
        connect(profilesAnimation, &QPropertyAnimation::finished, this, [this](){
